...
public class BlueprintTemplateProcessor {
    ...
    public String process(String blueprintText, Cluster cluster, Set<RDSConfig> rdsConfigs, AmbariDatabase ambariDatabase) throws IOException {
    ...
    private String generateBlueprintWithParameters(String blueprintText, Cluster cluster, Set<RDSConfig> rdsConfigs,
            AmbariDatabase ambariDatabase) throws IOException {
