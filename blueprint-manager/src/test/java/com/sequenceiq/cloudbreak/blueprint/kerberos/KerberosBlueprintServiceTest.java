...
public class KerberosBlueprintServiceTest {
    ...
    public void setup() {
        ...
        Mockito.when(stack.getPrimaryGatewayInstance()).thenReturn(TestUtil.instanceMetaData(1L, 1L, InstanceStatus.REGISTERED, true, instanceGroup));
        Mockito.when(stack.getInstanceGroups()).thenReturn(Collections.singleton(instanceGroup));
    }
    ...
    public void testExtendBlueprintWithKerberosOnKerberizedBlueprint() throws IOException {
        ...
        Mockito.when(stack.getCluster()).thenReturn(TestUtil.cluster(blueprint, stack, 1L, TestUtil.kerberosConfig()));
    ...
    public void testExtendBlueprintWithKerberosCustomConfig() throws IOException {
        ...
        Mockito.when(stack.getCluster()).thenReturn(TestUtil.cluster(blueprint, stack, 1L, kerberosConfig));
